...
class VoucherReviewForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'check_in_date': forms.DateInput(attrs={'class': 'form-control date-picker', 'type': 'text', 'placeholder': 'yy/mm/dd'}),
            'check_out_date': forms.DateInput(attrs={'class': 'form-control date-picker', 'type': 'text', 'placeholder': 'yy/mm/dd'}),
        }
